    ...
    <>
      ...
      <header className="sticky top-0 z-50 bg-ivory shadow-[0_1px_0_0_rgba(44,24,16,0.1)]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-[60px] flex items-center gap-4">
          ...
          {/* Logo — fixed left */}
          <Link href="/" aria-label="Narya Kitchenware" className="flex items-center gap-2.5 shrink-0">
            <LogoMark />
            <span className="font-serif tracking-[0.25em] text-forest text-[23px] select-none leading-none">
              NARYA
            </span>
          </Link>
          ...
          <div className="hidden sm:flex flex-1 justify-center px-6">
            <div className="w-full max-w-lg relative">
              ...
              />
              <svg className="absolute right-4 top-1/2 -translate-y-1/2 text-forest/45 pointer-events-none" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
          ...
          <div className="flex items-center gap-1 shrink-0">
            ...
            <button
              ...
              aria-label="Search"
              className="sm:hidden flex items-center justify-center w-10 h-10 rounded-xl bg-white border border-forest/15 shadow-sm text-forest/60 hover:text-forest transition-colors"
            >
            ...
            <Link href="/account" aria-label="Account" title="My Account" className="p-2 text-forest/55 hover:text-forest transition-colors flex">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round">
                <circle cx="12" cy="8" r="4" /><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7" />
              </svg>
            </Link>
            <Link href="/wishlist" aria-label="Wishlist" title="My Wishlist" className="p-2 text-forest/55 hover:text-forest transition-colors flex">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round">
            ...
            {/* Rewards — gift box */}
            <Link href="/rewards" aria-label="My Rewards" title="My Rewards" className="p-2 text-forest/55 hover:text-forest transition-colors flex">
          ...
          <div className="sm:hidden border-t border-forest/10 bg-white px-4 py-3 shadow-md">
            <div className="relative">
              <input
                ...
                type="search"
                placeholder="Search products…"
                className="w-full h-10 rounded-full border border-forest/20 bg-ivory pl-4 pr-12 text-sm text-forest placeholder:text-forest/35 focus:outline-none focus:border-forest/50 focus:ring-1 focus:ring-forest/20 transition"
              />
              <button className="absolute right-1 top-1/2 -translate-y-1/2 bg-earth text-ivory h-8 px-4 rounded-full text-xs font-semibold">
                Search
              </button>
            </div>
          </div>
